function selfCheck() {
  console.log(`Ваша оценка - 210 баллов 
    Отзыв по пунктам ТЗ:
    Частично выполненные пункты:
    1) +5 анимация появления модального окна с информацией о картине 
    
    2) +5 дополнительный функционал - возможность скачать картину
